...
// pontuação de 'resultado1' e primeira parte da mensagem de escolha.
        switch(opcao1){
            ...
            case 'p':
                ...
                printf("Você escolheu POPULACÃO e ");
                break;

            case 'A':
            case 'a':
                resultado1 = area01 > area02 ? 1:0;
                printf("Você escolheu ÁREA e ");
                break;
            case 'I':
            case 'i':
                resultado1 = pib01 > pib02 ? 1:0;
                printf("Você escolheu PIB e ");
                break;
            case 'T':
            case 't':
                resultado1 = turismo01 > turismo02 ? 1:0;
                printf("Você escolheu TURISMO e ");
                break;
            case 'D':
            case 'd':
                resultado1 = densidade_demografica01 < densidade_demografica02 ? 1:0;
                printf("Você escolheu DENSIDADE DEMOGRAFICA e ");
                break;
            case 'C':
            case 'c':
                resultado1 = pib_per_capta01 > pib_per_capta02 ? 1:0;
                printf("Você escolheu PIB PER CAPTA e ");
                break;
            case 'S':
            case 's':
                resultado1 =sp01 > sp02 ? 1:0;
                printf("Você escolheu SUPER PODER e ");
                break;
            default:
